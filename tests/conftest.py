...
def time_periods():
    ...
    result_1 = (
        datetime.datetime(year=year_1, month=month_1, day=1, hour=hour_1, minute=minutes_1, second=seconds_1),
        datetime.datetime(year=year_1, month=month_1, day=day_1, hour=hour_1, minute=minutes_1, second=seconds_1),
    )
    result_2 = (
        datetime.datetime(year=year_2, month=month_2, day=1, hour=hour_2, minute=minutes_2, second=seconds_2),
        datetime.datetime(year=year_2, month=month_2, day=day_2, hour=hour_2, minute=minutes_2, second=seconds_2),
    )
...
def operations_in_period():
    ...
    operations = [
        {
            "operation_date": f"{day_1}.{month_1}.{year_1} 12:49:53",
            ...
            "bonuses": 0,
            "investment_rounding": 0,
            "amount_rounding": 3000.0,
        },
        {
...
def greetings():
    return [
        ("2020-12-20 03:10:10", "Доброй ночи"),
...
def cards_info():
    operations = [
        {
            "operation_date": "01.01.2018 12:49:53",
    ...
    cards = [
        {"last_digits": None, "total_spent": 3000, "cashback": 30.0},
        {"last_digits": "1234", "total_spent": 3000, "cashback": 30.0},
    ]
...
def the_biggest_payments():
    ...
    result = [
        {"category": "Переводы", "amount": 3000000},
        {"category": "Наличные", "amount": 300000},
        {"category": "Билеты Ж/Д", "amount": 30000},
        {"category": "Супермаркеты", "amount": 3000},
        {"category": "Фастфуд", "amount": 300},
        {"category": "Каршеринг", "amount": 30},
        {"category": "Связь", "amount": 3},
        {"category": "Остальное", "amount": 1},
    ]
...
def translations_and_cash():
    ...
    result = [{"category": "Наличные", "amount": 300000}, {"category": "Переводы", "amount": 3000000}]
...
def incomes():
    ...
    result = {
        ...
        "main": [{"category": "Пополнение", "amount": 3000000}, {"category": "Зарплата", "amount": 300000}],
    }
